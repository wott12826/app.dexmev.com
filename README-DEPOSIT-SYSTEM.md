# 🚀 Система автоматического начисления баланса DexMev

## 📋 Обзор

Система автоматически мониторит депозиты SOL на указанный кошелек и начисляет токены $DEXMEV пользователям в соотношении **1 SOL = 1000 токенов**.
